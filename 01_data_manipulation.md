...
Import the pups dataset using na formats all the missing values (.) and
the NAs to read as missing
...
skimming? using :: is for when you want to use one feature of a package
